...
<?php include ('../../datalayer/errors.php');?>
	...
	$query2="SELECT * FROM stylist WHERE services=('$services')";
	...
	?>
		...
		<select class="input-group2" name="StyID">
			
	<?php   while ($row2=mysqli_fetch_assoc($result2)) {
		?>
		
	 
		<option> <?php echo $row2['StylistID'] ?> </option>
